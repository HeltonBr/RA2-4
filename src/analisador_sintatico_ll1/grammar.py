...
def render_grammar_markdown(bundle: GrammarBundle) -> str:
    linhas = [
        ...
        "",
        "A linguagem da Fase 2 foi fatorada para manter analise preditiva LL(1) sem abrir mao do estilo pos-fixado.",
        "",
    ...
    linhas.extend(
        [
            ...
            "item           = NUMBER | stmt ;",
            "stmt_after_first = KW_RES | IDENTIFIER | item , stmt_after_second ;",
            "stmt_after_second = binary_op | relational_op | KW_IF | KW_WHILE | KW_SEQ | item , KW_IFELSE ;",
            "```",
            "",
        ]
    )
